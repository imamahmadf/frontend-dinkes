...
function SetiapSaat() {
  const [dataSetiapSaat, setDataSetiapSaat] = useState(null);
  ...
  async function fetchDataSetiapSaat() {
    await axios
      .get(
        `${
          import.meta.env.VITE_REACT_APP_API_BASE_URL
        }/informasi/get/4?page=${page}&limit=${limit}`
      )
      .then((res) => {
        setDataSetiapSaat(res.data.result);
