      ...
      >
        ...
        <VStack spacing={2} align="start">
          <Box display="flex" alignItems="center" gap={2}>
            ...
            <Text fontSize="sm">Puskesmas</Text>
          </Box>
          ...
          <Box display="flex" alignItems="center" gap={2}>
            ...
            <Text fontSize="sm">Puksesmas Pembantu</Text>
          </Box>
          ...
          <Box display="flex" alignItems="center" gap={2}>
            ...
            <Text fontSize="sm">Lokasi Umum</Text>
          </Box>
        </VStack>
        ...
        <VStack spacing={1} align="start">
          ...
          <Text fontSize="xs" color="gray.600">
            • Zoom 14+: Deskripsi lokasi
          </Text>
          <Text fontSize="xs" color="gray.600">
            • Zoom 16+: Detail lengkap
          </Text>
          <Text fontSize="xs" color="blue.500" fontStyle="italic">
            Tooltip diperbesar untuk kemudahan membaca
          </Text>
        </VStack>
      </Box>
    </Box>
